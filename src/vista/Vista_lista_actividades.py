...
class Vista_lista_actividades(QWidget):
    ...
    def mostrar_actividades(self):
        ...
        self.actividades = Listado_actividades.mostrar_actividades(self)
        self.actividades = Listado_actividades.ordenar_lista_actividades(self.actividades)
        ...
        if (self.actividades!= None and len(self.actividades)>0) :
            ...
            for item in self.actividades:
                ...
                btn_ver_actividad.clicked.connect(partial(self.mostrar_actividad,item) )
                ...
                btn_ver_viajeros.clicked.connect(partial(self.mostrar_dialogo_insertar_viajeros,item.id) )
                ...
                btn_editar.clicked.connect(partial(self.mostrar_dialogo_editar_actividad,item ) )
                ...
                btn_eliminar.clicked.connect(partial(self.eliminar_actividad, item))
    ...
    def mostrar_dialogo_insertar_viajeros(self,actividad):   
        ...
        dialogo.exec_()
        if dialogo.resultado == 1:
            self.interfaz.actualizar_viajeros(dialogo.viajeros,actividad)
    ...
    def eliminar_actividad(self,actividad):
        ...
        if respuesta == QMessageBox.Yes:
            if Crear_Actividad.actividad_tiene_gastos(actividad):
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
                msg.setText("La actividad tiene gastos y no puede ser borrada")
                msg.setInformativeText('Por favor elimine los gastos antes de borrar la actividad')
                msg.setWindowTitle("Actividad con gastos")
                msg.exec_()
            else:
                self.interfaz.eliminar_actividad(actividad)